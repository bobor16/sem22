...
import org.xtext.example.mydsl.garden.Component
...
class GardenGenerator extends AbstractGenerator {
	...
	override void doGenerate(Resource resource, IFileSystemAccess2 fsa, IGeneratorContext context) {
		for (e : resource.allContents.toIterable.filter(Component)) {
                fsa.generateFile("Arduinoscript.ino", e.compileGardenController)
        }
	}
	
	def compileGardenController(Component component)'''
	#include <esp_now.h>
	#include <WiFi.h>
